...
export const GENDER_TYPE = [
  { id: 1, name: '男', key: 'Male' },
  { id: 2, name: '女', key: 'Female' },
]
...
export const COLLEGE_TYPE = [
  ...
  { id: 1, name: "01 建筑学院" },
  { id: 2, name: "02 机械工程学院" },
  { id: 3, name: "03 能源与环境学院" },
  { id: 4, name: "04 信息科学与工程学院" },
  { id: 5, name: "05 土木工程学院" },
  { id: 6, name: "06 电子科学与工程学院" },
  { id: 7, name: "07 数学学院" },
  { id: 8, name: "08 自动化学院" },
  { id: 9, name: '09 计算机科学与工程学院' },
  { id: 10, name: "10 物理学院" },
  { id: 11, name: "11 生物科学与医学工程学院" },
  { id: 12, name: "12 材料科学与工程学院" },
  { id: 13, name: "13 人文学院" },
  { id: 14, name: "14 经济管理学院" },
  { id: 15, name: "15 哲学系" },
  { id: 16, name: "16 电气工程学院" },
  { id: 17, name: '17 外国语学院' },
  { id: 18, name: "18 体育系" },
  { id: 19, name: "19 化学化工学院" },
  { id: 21, name: "21 交通学院" },
  { id: 22, name: "22 仪器科学与工程学院" },
  { id: 23, name: "23 旅游管理系" },
  { id: 24, name: "24 艺术学院" },
  { id: 25, name: "25 法学院" },
  { id: 26, name: "41 医学院" },
  { id: 27, name: "42 公共卫生学院" },
  { id: 28, name: "61 吴健雄学院" },
  { id: 29, name: "71 软件学院" },
  { id: 30, name: "海外教育学院" },
  { id: 31, name: "微电子学院" },
  ...
  { id: 33, name: "网络空间安全学院" },
  { id: 34, name: "人工智能学院" },
  { id: 35, name: "东南大学雷恩研究生学院" },
  { id: 36, name: "东南大学—蒙纳士大学苏州联合研究生院" },
  { id: 37, name: "东南大学生命科学与技术学院" },
]
